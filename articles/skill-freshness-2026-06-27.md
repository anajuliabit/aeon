...
- **operator-scorecard** — 1 dep, all fresh. (`articles/skill-analytics-2026-06-24.md`, ~62h old, weekly threshold 192h ✅)
...
- Files not yet on disk (skipped — implicit references that never existed): ~10 (heartbeat articles, push-recap, repo-actions, token-report, repo-pulse, tweet-allocator, repo-article, distribute-tokens, fork-contributor-leaderboard — all from disabled producers; project-lens classified on_demand per cadence rule)
