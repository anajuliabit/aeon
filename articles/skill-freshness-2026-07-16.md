...
- Dedup status: `FRESHNESS_NO_CHANGE` — fingerprint identical to 2026-07-15 run (sha1=da39a3ee, same FRESHNESS_OK verdict, last run ~24 h ago, within 7-day re-emit window)
...
|----------|---------------|-----|-------|------|
| cost-report | `cost-report-2026-06-29.md` | ~408 h (17 d) | articles/weekly | STALE (>384 h, >2×192 h) |
| weekly-shiplog | `weekly-shiplog-2026-06-29.md` | ~408 h (17 d) | articles/weekly | STALE (>384 h, >2×192 h) |

Both remain in the same STALE band entered on 2026-07-15 (crossed from WARN at ~385 h). Root cause per MEMORY.md: Monday-slot scheduler miss streak (ISS-027 / rule-5 workflow-file class block). `skill-health` tracks and files issues; this skill reports only.
