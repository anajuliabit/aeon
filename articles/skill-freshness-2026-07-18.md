...
- Dedup status: `FRESHNESS_OK` — fingerprint identical to 2026-07-17 run (sha1=da39a3ee, same FRESHNESS_OK verdict, last run ~24 h ago, within 7-day re-emit window); no notification sent (OK verdict is always silent)
...
|----------|---------------|-----|-------|------|
| cost-report | `cost-report-2026-06-29.md` | ~456 h (19 d) | articles/weekly | STALE (>384 h, >2×192 h) |
| weekly-shiplog | `weekly-shiplog-2026-06-29.md` | ~456 h (19 d) | articles/weekly | STALE (>384 h, >2×192 h) |

Both remain in the STALE band (entered 2026-07-15; +24 h since yesterday's run). Root cause per MEMORY.md: Monday-slot scheduler miss streak (ISS-025 / ISS-027). `skill-health` tracks and files issues; this skill reports only.
