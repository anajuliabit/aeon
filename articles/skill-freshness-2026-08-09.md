...
**Verdict:** 🔴 FRESHNESS_STALE — 1 dep stale across 1 consumer; no change since 2026-08-08
...
|----------|-----------|-------|-----|----------|
| skill-security-scan | `articles/workflow-security-audit-2026-04-11.md` | articles (weekly) | 120 days | 🔴 STALE |

## What this means per consumer

**skill-security-scan** — depends on 1 flagged file. Worst: `articles/workflow-security-audit-2026-04-11.md` last updated 2026-04-11 (threshold 192h/8d, class articles-weekly). Producer `workflow-security-audit` is disabled (schedule `0 16 * * 0`, last ran 2026-04-11, 120 days ago). References appear in prose as historical documentation (lines 19 and 132 of skill-security-scan's SKILL.md), not an active data read. Persistent since first flagged 2026-07-25 (15 days). Suggested action: add `<!-- skill-freshness:ignore -->` to suppress if not an active runtime read, or re-enable `workflow-security-audit` if the doc reference implies a live dependency.

## Healthy consumers

- aixbt-pulse — 3 deps (memory/topics/aixbt-grounding.md, aixbt-clusters.md, aixbt-chains.md), all fresh (~43min vs 168h threshold; committed 07:21 UTC today's daily-routine batch).
- market-context-refresh — 1 dep (memory/topics/market-context.md), fresh (~43min vs 168h threshold).
- token-pick — 1 dep (memory/topics/market-context.md), fresh.
- vuln-scanner — 1 dep (.outputs/github-trending.md), fresh (~43min vs 4h threshold; committed 07:21 UTC today's daily-routine batch).
- operator-scorecard — 1 dep (articles/skill-analytics-2026-08-05.md), fresh (~97h vs 192h/8d threshold).
+ 37 more all-fresh consumers.

## Δ vs prior run (2026-08-08)
...
1 persistent STALE flag (first flagged 2026-07-25, day 15):
- 🔴 `skill-security-scan:articles/workflow-security-audit-2026-04-11.md`

Notification suppressed: `FRESHNESS_NO_CHANGE` (fingerprint stable since 2026-08-08, within 7-day re-emit window).
