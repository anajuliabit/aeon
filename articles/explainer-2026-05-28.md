...
<!-- image prompt: "Dark-mode technical system diagram in the Powerloom BDS Agent Framework reference style. Near-black canvas (#0b1117) with a faint dotted-grid background. Central hexagonal engine node labeled 'AEON chain-runner (GitHub Actions)' in monospace, sitting at the visual center; thin cyan (#22d3ee) directional arrows fan out from the engine to the right toward four stacked horizontal lanes; lime-green (#22c55e) inline annotation labels sit above each arrow. The four labeled lanes, top to bottom: 'DATA INGESTION — Reppo CLI catalog · HL leaderboard · HL OHLCV cache', 'VERIFICATION — rubric · orchestrator RUN/SKIP · fenced reppo-plan block', 'REASONING — trading-agent · fills × candles → labeled dataset', 'EXECUTION — .pending-reppo · postprocess · Base mint/vote'. Each lane is a thin-stroked rounded rectangle with the lane title in cyan caps and 2–3 small sub-boxes inside. A single thicker cyan output arrow exits the right edge of the EXECUTION lane and terminates at a small node labeled 'Base mainnet'. Monospace technical-paper figure style, 16:9 landscape, blueprint energy, no human figures, no glow, no gradient slop, no decorative icons." -->
...
- **3 mints + 9 votes** onchain to date from this swarm — first mint [0x77f138…](https://basescan.org/tx/0x77f1386fb6fe3209bbf1a380b2be64f1f1c2c557416c9c7c0d31486a7e48a61f) on 2026-05-26, latest vote-pair [0xac2ec2…](https://basescan.org/tx/0xac2ec23b2f623caa962f9aa5560bc589947ec9842a5fbf1e6dba2333075f5801) / [0xf78cc2…](https://basescan.org/tx/0xf78cc26af15e0b432de6f4a2bd60fc5a5851d5e69ac4f3c0106c3ced1f552dcb) on 2026-05-28 — that's 6× DISLIKE on each of pods 372/373 in a single UTC day, the ISS-005 dedup gap as a live receipt ([ledger](../memory/topics/reppo.md)).
