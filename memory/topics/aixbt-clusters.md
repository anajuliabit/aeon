# AIXBT Clusters (as of 2026-06-26)

36 sub-community clusters AIXBT tracks. Each cluster has a description and member archetype. Used when filtering projects/intel/momentum endpoints (paid tier).
...
| ASSET_MANAGER | Asset Manager | regulated fund, ETF issuer, custodian, or AUM-oriented crypto firm |
...
| CULTURE_SIGNAL | Culture Signal | celebrity, creator, athlete, musician, gaming, or retail-culture with crypto relevance |
...
| ETH_MAXI | ETH Maxi | ethereum-only smart-contract-platform conviction |
| EDUCATOR | Educator | free guides, walkthroughs, rules, and teaching-first content |
| EVENT | Event | crypto conference, hackathon, summit, or recurring event account |
| EXCHANGE | Exchange | CEX or DEX-affiliated accounts, listings, volume, and incidents |
| FOUNDER | Founder | runs a protocol or company; product updates plus vision |
| INVESTIGATOR | Investigator | wallet tracing, scam, rug, or exploit investigation |
| LEGAL | Legal | crypto lawyers and legal or compliance professionals |
| MACRO | Macro | tradfi, rates, liquidity, equities, commodities, geopolitics, or macro finance |
| MARKETING | Marketing | growth, community, content, campaigns, and brand narrative |
| MEDIA | Media | journalists, podcasts, crypto-native outlets, and beat coverage |
...
| SERVICE_PROVIDER | Service Provider | crypto service company: audit, OTC, custody, analytics, data, or infra |
| SHILLER | Shiller | paid alpha, sponsored promos, referral-driven calls, or paid groups |
