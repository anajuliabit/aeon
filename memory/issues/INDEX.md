...
| ISS-031 | usepod.ai LLM proxy 402 Payment Required — fleet-wide dispatch failure 2026-08-10 (ISS-029 recurrence) | critical | missing-secret | 2026-08-10 | btc-levels, cost-report, thought-review, daily-routine, skill-freshness, weekly-shiplog, heartbeat, security-digest, morning-brief, github-trending, unlock-monitor, token-alert, deal-flow, goal-tracker, list-digest, skill-security-scan, action-converter, reflect, skill-health, agent-buzz, search-skill |
...
| ISS-029 | usepod.ai LLM proxy 402 Payment Required — fleet-wide dispatch failure 8-03; usepod gateway self-healed 2026-08-03T20:14Z (~2h outage); 44h+ clean through 8-05 | critical | missing-secret | usepod self-healed (no PR) | 2026-08-04 |
