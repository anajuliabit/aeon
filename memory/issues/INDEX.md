...
| ISS-009 | reppo-orchestrator drops the fenced reppo-plan block — LLM emits only `## Summary` | medium | prompt-bug | 2026-05-26 | reppo-orchestrator, reppo-trading-agent, reppo-digest |
...
| ISS-006 | Reppo vote dry-run fails — publisher has 0 voting power | high | https://github.com/anajuliabit/aeon/pull/11 | 2026-05-26 |
