...
| ISS-012 | Reppo platform metadata POST fails HTTP 400 for queued mint (Phase 2) | medium | api-change | 2026-05-29 | reppo-trading-agent, reppo-digest |
| ISS-013 | Reppo dataset IPFS pin to Pinata fails HTTP 403 (Phase 2) | medium | missing-secret | 2026-05-29 | reppo-trading-agent, reppo-digest |
