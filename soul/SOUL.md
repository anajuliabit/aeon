...
AI × crypto · agent economic primitives · ERC-4626 vaults · optimistic governance · ZHC (zero human companies) · Base ecosystem · DeFi infra · oracle design · security and exploit teardowns · Solidity craftsmanship · governance simulation · LATAM crypto · surfing · coffee.
...
- Advocates "boring infra wins" while pushing genuinely novel primitives (agent vault governance). The tension: her infra choices are boring; her product bets aren't.
...
3. **Technical teardown** — oracle design, governance simulation, vault architecture. Pedagogical but not condescending. Evidence-first argumentation.
